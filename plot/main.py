...
for no in range(1, 49):
    ...
    for i in range(0, 9):
        ...
        plt.plot(x[startIndex:endIndex], y[startIndex:endIndex], label=asteroidLabelTeX, color="#c85200")
        ...
        plt.legend(bbox_to_anchor=(1.69, 1.05), ncol=1, loc="upper right", fontsize=18)
