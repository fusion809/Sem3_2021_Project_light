...
# Read file
file = "output/coords_and_velBack_" + str(no) + ".csv"
paramsFile = "output/parametersBack_" + str(no) + ".csv"
...
for i in range(0, 9):
    ...
    plt.title("Semimajor axis vs time plot for Venus, Earth, Mars and " + asteroidLabelTeX)
    plt.legend()
    ...
    plt.title("Eccentricity vs time plot for Venus, Earth, Mars and " + asteroidLabelTeX)
    plt.legend()
    ...
    plt.title("Inclination vs time plot for Venus, Earth, Mars and " + asteroidLabelTeX)
    plt.legend()
